...
We communicate effectively when we communicate to as many people as possible

This means making our work .b[open] and .b[accessible] to a broad audience
...
.footnote[
[2.1 Make “accessible” your default mindset |<br> Making Scientific Content More Accessible](https://www.authorea.com/users/152134/articles/206076-making-scientific-content-more-accessible/#author-label-make-accessible-your-default-mindset)<br>
...
Oral presentations require different design considerations than papers or posters

- Visual cues for figures
- Clear audio when speaking

Effectively communicating using a slide deck also requires .b[designing content with fewer and more focused details]
...
.footnote[
[2.2 Design for the mode of delivery | Making Scientific Content More Accessible](https://www.authorea.com/users/152134/articles/206076-making-scientific-content-more-accessible/#author-label-design-for-the-mode-of-delivery)<br>
...
[Example slide: not good](#visual-not-good)<img src="assets/img/04/visual-not-good.png" alt="Slide containing only plain text provided in paragraph form and going across the entire slide" width="75%" style="float: right;"/>

] <!--end of panel-->

.panel[.panel-name[Good]

[Example slide: good](#visual-good)<img src="assets/img/04/visual-good.png" alt="Text has been moved to the left of the slide and an image has been inserted next to it on the right side" width="75%" style="float: right;"/>

] <!--end of panel-->

.panel[.panel-name[Better]

[Example slide: better](#visual-better)<img src="assets/img/04/visual-better.png" alt="Text remains on the left of the slide but now the image is a background image taking up the right side of the slide fully and without interfering with the text" width="75%" style="float: right;"/>
...
[Example slide: ok](#focus-ok)<img src="assets/img/04/focus-ok.png" alt="Paragraph text on the left of the slide and a background image on the right" width="75%" style="float: right;"/>

] <!--end of panel-->

.panel[.panel-name[Good]

[Example slide: good](#focus-good)<img src="assets/img/04/focus-good.png" alt="Paragraph text has been removed of unnecessary wording and organized into bullet points. Background image remains on the right." width="75%" style="float: right;"/>

] <!--end of panel-->

.panel[.panel-name[Better]

[Example slide: good](#focus-better)<img src="assets/img/04/focus-better.png" alt="The bullet point list of text now has some words highlighted with a bold blue font face for emphasis, Background image remains on the right." width="75%" style="float: right;"/>
...
.f6[
- your audience to process and understand during<br>your presentation
...
.footnote[[2.4 Use clear and simple figures and graphics | Making Scientific Content More Accessible](https://www.authorea.com/users/152134/articles/206076-making-scientific-content-more-accessible/#author-label-use-clear-and-simple-figures-and-graphics)]
...
- Introduce packages and functions

- Define field-specific terminology or jargon

- Write to an audience outside of disciplinary silos<br>and even outside of academia
]

.footnote[[2.7 Write clearly | Making Scientific Content More Accessible](https://www.authorea.com/users/152134/articles/206076-making-scientific-content-more-accessible/#author-label-write-clearly)]
...
From [Web Accessibility in Mind](https://webaim.org/techniques/writing/#intelligent)

- 8th grade reading level if targeting a broad audience

- 12th grade reading level for an educated or specialized audience
...
## `r fa("theater-masks")` Meet back at the  [course site](/materials/act-02/04-effective-communication#activity)
...
### All use example text from the [Duke Lemur Center site](https://lemur.duke.edu/100-lemurs/)
