...
`r fa("far fa-square")` .b[Make "accessible" your default mindset]

`r fa("far fa-square")` Support images with text 

`r fa("far fa-square")` Make sure hyperlinks are clear & unambiguous

`r fa("far fa-square")` Choose colors carefully
...
- .b[Caption:] Brief description of what is being shown in the image

- .b[Alt-text:] Full description that allows the reader to understand the figure without seeing it
...
.footnote[
[2.6 Support images with text | Making Scientific Content More Accessible](https://www.authorea.com/users/152134/articles/206076-making-scientific-content-more-accessible/#author-label-imagetext)]
...
## `r fa("question-circle")` Can I use the same alt-text for all images<br> that are identical?
...
- xaringan makes it possible to .b[embed hyperlinks] in our slides

- Links should be .b[clearly labeled]

- .b[Avoid ambiguous link text] like: <br>"click here," "here," "more," "read more," "info"
]

.footnote[[2.9 Make sure hyperlinks are clear & unambiguous | Making Scientific Content More Accessible](https://www.authorea.com/users/152134/articles/206076-making-scientific-content-more-accessible/#author-label-make-sure-hyperlinks-are-clear-unambiguous)<br>
...
---
background-image: url(assets/img/05/paint-rollers.jpg)
background-position: right
background-size: contain
...
- Avoid using color as the .b[only] indicator of priority, importance, or an interactive element
...
.footnote[[2.5 Choose colors carefully | Making Scientific Content More Accessible](https://www.authorea.com/users/152134/articles/206076-making-scientific-content-more-accessible/#author-label-choose-colors-carefully)<br>
...
- Use one of the following color contrast checkers
  ...
  - [A11y Color Palette](https://a11yrocks.com/colorPalette/) by Matt Long
  
  - [Accessible color palette builder](https://toolness.github.io/accessible-color-matrix/) by Atul Varma

- For an extensive gallery of accessible color combinations<br> see the [Tachyons documentation for Theme Skins](https://tachyons.io/docs/themes/skins/)
...
.f7.mt4.mb4[
`r fa("far fa-check-square")` .b[Make "accessible" your default mindset]

`r fa("far fa-check-square")` Support images with text 

`r fa("far fa-check-square")` Make sure hyperlinks are clear & unambiguous

`r fa("far fa-check-square")` Choose colors carefully
]

## `r fa("theater-masks")` Let's meet back at the<br>  [05-accessible-design activity](/materials/act-02/05-accessible-design#activity)
